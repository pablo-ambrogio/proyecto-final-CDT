...
const AboutUs = () => {
    return (
        <>
            <h1 className="text-blue text-2xl uppercase font-modern p-2">sobre nosotros</h1>
            <main className="grid place-items-center grid-cols-3 gap-4 items-end">
                ...
                <img className="justify-end" src={car} alt="Car" />
            </main>
        </>
    )
}
