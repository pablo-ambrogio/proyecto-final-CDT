...
import Modal from '../../pages/ModalLogin'
    ...
    return (
        <header className="w-full bg-blue sticky top-0">
            <section className="grid grid-cols-12 p-4 uppercase items-center">
                <Link
                    to="/"
                    className="col-span-2 flex justify-center items-center hover:transition-in-out duration-300 hover:scale-110 hover:transition-in-out"
                >
                ...
                <nav className="col-span-7 flex justify-evenly font-bold">
                    <Link
                        to="/"
                        className="hover:text-red text-grey hover:transition-in-out duration-300"
                    >
                        vehículos
                    </Link>
                    <Link
                ...
                <div className="col-span-3 capitalize text-center font-bold">
                    <Link
                        to="/register"
                        className="bg-red hover:bg-grey hover:text-blue px-6 py-2 rounded-lg mr-2 transition-in-out duration-700 inline-block"
                    >
                        crear cuenta
                    </Link>
                    {/* <Link to="/login" className="bg-red hover:bg-grey hover:text-blue px-6 py-2 rounded-lg inline-block" >
                        iniciar sesión
                    </Link> */}
                    <Modal />
                </div>
            ...
            <section className="grid grid-cols-5 gap-8 bg-blue2 uppercase p-2 items-center justify-evenly">
                <input
                    className="grid col-span-3 p-2 rounded-md bg-grey ml-10"
                    type="text"
                    placeholder="Informa el punto de retirada (Ej: Buenos Aires, Bogotá)"
                />
                <input
                    className="p-2 rounded-md bg-grey"
                    type="date"
                    placeholder="Fecha"
                />
                <input
                    className="p-2 rounded-md bg-grey mr-10"
                    type="time"
                    placeholder="hora"
                />
            </section>
