...
const Navbar = () => {
    return (
        <header className="w-full bg-blue">
            <section className="flex items-center justify-between mx-auto uppercase p-5">
                ...
                <div className="capitalize flex gap-2 items-center">
                    <Link to="/register" className="bg-red font-bold w-48 py-2 rounded text-center">
                        crear cuenta
                    </Link>
                    <Link to="/login" className="bg-red font-bold w-48 py-2 rounded text-center">
                        iniciar sesión
                    </Link>
                </div>
            </section>
